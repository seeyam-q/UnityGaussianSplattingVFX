...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        internal static readonly ProfilerMarker s_ProfVFXData =
            new(ProfilerCategory.Render, "GaussianSplat.CalcVFXData", MarkerFlags.SampleGPU);
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb)
        {
            ...
            foreach (var kvp in m_ActiveSplats)
            {
                ...
                if (gs.m_RenderMode == GaussianSplatRenderer.RenderMode.VFXDataOnly)
                {
                    cmb.BeginSample(s_ProfVFXData);
                    gs.CalcVfxData(cmb, cam, matrix);
                    cmb.EndSample(s_ProfVFXData);
                    continue;
                }
                ...
                Material displayMat = gs.m_RenderMode switch
                {
                    ...
                    GaussianSplatRenderer.RenderMode.VFXDataOnly => null,
                    _ => gs.m_MatSplats
                };
                if (displayMat == null)
                    continue;
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        internal GraphicsBuffer m_SplatsVfxData;
        public GraphicsBuffer SplatsVfxData => m_SplatsVfxData;
        ...
        internal static class Props
        {
            ...
            public static readonly int SplatVfxData = Shader.PropertyToID("_SplatVfxData");
        ...
        void CreateResourcesForAsset()
        {
            ...
            m_SplatsVfxData = new GraphicsBuffer(GraphicsBuffer.Target.Structured, m_Asset.splatCount, kVfxDataSize);
        ...
        void SetAssetDataOnCS(CommandBuffer cmb, KernelIndices kernel)
        {
            ...
            cmb.SetComputeBufferParam(cs, kernelIndex, Props.SplatVfxData, m_SplatsVfxData);
        ...
        void DisposeResourcesForAsset()
        {
            ...
            DisposeBuffer(ref m_SplatsVfxData);
        ...
        internal void CalcVfxData(CommandBuffer cmb, Camera cam, Matrix4x4 matrix)
        {
            if (cam.cameraType == CameraType.Preview)
                return;
            var tr = transform;
            ...
            Vector4 camPos = cam.transform.position;
// calculate view dependent data for each splat
            SetAssetDataOnCS(cmb, KernelIndices.CalcVfxData);
            cmb.SetComputeMatrixParam(m_CSSplatUtilities, Props.MatrixMV, matView * matO2W);
            cmb.SetComputeMatrixParam(m_CSSplatUtilities, Props.MatrixObjectToWorld, matO2W);
            cmb.SetComputeMatrixParam(m_CSSplatUtilities, Props.MatrixWorldToObject, matW2O);
            ...
            m_CSSplatUtilities.GetKernelThreadGroupSizes((int)KernelIndices.CalcVfxData, out uint gsX, out _, out _);
            cmb.DispatchCompute(m_CSSplatUtilities, (int)KernelIndices.CalcVfxData,
                (m_GpuView.count + (int)gsX - 1) / (int)gsX, 1, 1);

            vfxDataCalculated?.Invoke(cam);
        }

        public event Action<Camera> vfxDataCalculated;
